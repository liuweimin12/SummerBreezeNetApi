...
namespace Yun.Marketing.Request
{
    /// <summary>
    /// 新增组合促销活动
    /// chenggou.promotionmisc.combinationbuy.activity.add
    /// </summary>
    public class AddCombinationBuyRequest : ITopRequest<IntResultResponse>
    {
        /// <summary>
        /// 活动名称
        /// </summary>
        ...
        /// 需要添加的商品信息，Json字符串
        /// </summary>
        public List<AddCombinationItemsJson> Items { get; set; }
        ...
        {
            return "chenggou.promotionmisc.combinationbuy.activity.add";
        }
