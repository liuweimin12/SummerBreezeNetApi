...
namespace Yun.Util
{
    ...
    public sealed class RequestValidator
    {
        ...
        public static void ValidateRequired(string name, object value)
        {
            if (value == null)
            {
                throw new YunException(ERR_CODE_PARAM_MISSING, string.Format(ERR_MSG_PARAM_MISSING, name));
            }
        ...
        public static void ValidateMaxLength(string name, string value, int maxLength)
        {
            ...
            {
                throw new YunException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
            }
        }
        ...
        /// <param name="value">参数值</param>
        /// <param name="maxValue">最大值</param>
        public static void ValidateMaxValue(string name, Nullable<double> value, long maxValue)
        {
            if (value != null && value > maxValue)
            {
                throw new YunException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
        ...
        /// <param name="value">参数值</param>
        /// <param name="minValue">最小值</param>
        public static void ValidateMinValue(string name, Nullable<double> value, double minValue)
        {
            if (value != null && value < minValue)
            {
                throw new YunException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
